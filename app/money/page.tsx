      ...
      <div style={styles.shell}>
        <header style={styles.header}>
          <div>
            ...
            <div style={{ opacity: 0.78, marginTop: 6 }}>
              Master dashboard (everything ties together)
            </div>
        ...
        <div style={styles.grid3}>
          ...
          <SummaryCard
            ...
            value={fmt(debtTotals.creditBal)}
            hint="Sum of credit cards with balances."
          />
          <SummaryCard
            title="Loan Balances"
            value={fmt(debtTotals.loanBal)}
            hint="Sum of loans with balances."
          />
        </div>
